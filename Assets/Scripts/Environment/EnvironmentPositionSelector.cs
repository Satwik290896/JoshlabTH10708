...
public class EnvironmentPositionSelector : MonoBehaviour {
	...
	void Update () {
		if (shouldSelect) {
			GetMovementInput();
			UnityEngine.Debug.Log("EnvironmentPositionSelector: position: " + PositionSelector.transform.position);
		}
	}
	...
	public Vector3 GetSelectorPosition(){
		UnityEngine.Debug.Log("Selector Position: " + PositionSelector.transform.position);
