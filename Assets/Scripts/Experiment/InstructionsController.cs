...
public class InstructionsController : MonoBehaviour {
	...
	public string pressToSelect = "press (Anywhere) to select";
	public string selectTheLocationText = "Select the location of the ";

	public string pressToContinue = "press (Anywhere) to continue";
	public string pressToStart = "Press (Anywhere) to start!";
